...
- **What this doesn't handle:** boot-time engine-plugin compatibility with the host's interface contracts — that's tracked separately as future interface-versioning work.
