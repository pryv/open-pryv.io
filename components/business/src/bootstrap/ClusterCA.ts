...
class ClusterCA {
  ...
  nodeValidityDays: number;

  constructor ({ dir, caValidityDays = DEFAULT_CA_VALIDITY_DAYS, nodeValidityDays = DEFAULT_NODE_VALIDITY_DAYS }: { dir: string; caValidityDays?: number; nodeValidityDays?: number; }) {
