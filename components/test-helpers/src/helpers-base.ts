...
async function initCore () {
  ...
  const methods = options.methods || ['events', 'streams', 'service', 'auth/login', 'auth/register', 'accesses', 'account', 'profile', 'webhooks', 'shared-secrets', 'utility', 'mfa', 'delegations'];
